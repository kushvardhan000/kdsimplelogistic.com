...
<body class="flex min-h-screen flex-col items-center justify-center bg-zinc-50 px-4 dark:bg-zinc-950">
    <div class="w-full max-w-md text-center">
        <h1 class="text-6xl font-bold text-zinc-900 dark:text-zinc-50">403</h1>
        <p class="mt-2 text-lg text-zinc-600 dark:text-zinc-400">Forbidden</p>
        <p class="mt-1 text-sm text-zinc-500 dark:text-zinc-400">You do not have permission to access this resource.</p>
