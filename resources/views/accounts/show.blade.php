...
@section('content')
    ...
    @if(($account->type === 'fuel_station' || $account->type === 'staff') && ($account->bank_account_no || $account->bank_ifsc_code || $account->bank_name))
        <div class="mt-6 rounded-xl border border-zinc-200 bg-white p-4 shadow-premium-sm dark:border-zinc-800 dark:bg-zinc-900">
    ...
    <div class="mt-6">
        <x-accounts.filters-bar :action="request()->url()" preserve="type" :paymentModes="$paymentModes" />
    </div>
